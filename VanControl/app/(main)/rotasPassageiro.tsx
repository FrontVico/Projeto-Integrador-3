...
export default function RotasPassageiroScreen({ user }: Props) {
  ...
  return (
    ...
    >
      <LinearGradient colors={['#050a1e', '#07152f']} style={styles.hero}>
        ...
        <Text style={styles.heroTitle}>Rotas para passageiros</Text>
        <Text style={styles.heroSubtitle}>Busque por destino e veja todas as rotas disponíveis no sistema.</Text>
      ...
      <Animated.View style={[styles.body, { transform: [{ translateY: slideAnim }] }]}> 
        ...
        {rotas.length === 0 ? (
          <View style={styles.messageCard}>
            ...
            <Text style={styles.messageText}>Tente outro destino ou aguarde o administrador cadastrar novas rotas.</Text>
          </View>
        ) : (
          rotas.map((rota) => (
